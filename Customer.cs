...
namespace Sales_Assessment
{
    ...
    class Assessment_bill
    {
        public static void ReadProducts()
        {
            SqlConnection con = new SqlConnection(); //for connection name
            con.ConnectionString = @"data source =IN5CG9214YJZ; database = DB_First_Demo; integrated security = true";
        ...
        static void DisplayBill(int xId)
        {
            ...
            SqlCommand cmd = new SqlCommand(); // for DML command
                                               ...
                                               // xId = int.Parse(Console.ReadLine());
            ...
            SqlDataReader rdr = cmd.ExecuteReader();
            //cust.Name = (string)rdr[1];
            //cust.ProductId = (int)rdr[2];
            //cust.SupplierId = (int)rdr[3];
            //cust.Quantity = (int)rdr[4];
            //cust.Total = (int)rdr[5];
